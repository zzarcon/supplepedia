module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		concat: {
			vendor: {
				src: ['app/library/jquery-1.9.1.js', 'app/library/handlebars-1.3.0.js', 'app/library/ember-1.4.0.js', 'app/library/ember-data-1.0.0-beta.7.js'],
				dest: 'debug/lib.js'
			},
			app: {
				src: ['app/app.js', 'debug/templates.js', 'app/models/*.js', 'app/controllers/*.js', 'app/views/*.js', 'app/routes/*.js'],
				dest: 'debug/app.js'
			},
			test: {
				src: ['app/tests/*.js'],
		...
		watch: {
			...
			scripts: {
				files: ['app/library/*.js', 'app/*.js', 'app/models/*.js', 'app/controllers/*.js', 'app/views/*.js', 'app/routes/*.js', 'app/css/*.scss', 'app/templates/**/*.hbs', 'app/tests/*.js'],
